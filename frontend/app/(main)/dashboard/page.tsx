...
const DashboardClient = () => {
  ...
  const showExpiry = config.features.expiryTracking;
  ...
  const stats = [
    ...
    // Only show expiry stat for store types that track expiry
    ...(showExpiry
      ? [
          {
            title: "Expiring Soon",
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Expiring Soon Watchlist — only for stores that track expiry */}
        {showExpiry && expiringSoon && expiringSoon.length > 0 && (
          <>
            <motion.div
