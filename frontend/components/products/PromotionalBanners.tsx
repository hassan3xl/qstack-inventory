...
const PromotionalBanners = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
      <div className="relative bg-linear-to-r from-green-500 to-teal-600 rounded-lg p-8 overflow-hidden h-64">
      ...
      <div className="relative bg-linear-to-r from-pink-500 to-rose-600 rounded-lg p-8 overflow-hidden h-64">
        <div className="relative z-10">
